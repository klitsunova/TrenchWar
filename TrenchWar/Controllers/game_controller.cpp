...
void GameController::SetWorldObjects() {
  ...
  world_->AddSoldier(QPoint(5, 7), Soldier::Type::kAttacker);
  // world_->AddSoldier(QPoint(6, 6), Soldier::Type::kAttacker);
  world_->AddSoldier(QPoint(3, 3), Soldier::Type::kDefender);
}
